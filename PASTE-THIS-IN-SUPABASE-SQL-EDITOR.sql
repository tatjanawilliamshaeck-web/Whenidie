-- =============================================================================
-- WHEN I DIE™ – SUPABASE SETUP
-- Copy *everything* in this file (from the next line down) and paste it into
-- the Supabase Dashboard → SQL Editor → New query. Then click Run.
-- Do NOT paste the file path; paste the SQL contents only.
-- =============================================================================
...
-- Questions: the prompts users answer
...
-- Drop policies if they exist (so this script can be run again safely)
...
drop policy if exists "Users can read own shares" on public.shares;
